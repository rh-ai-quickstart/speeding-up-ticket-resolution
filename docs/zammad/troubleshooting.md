...
| Area | Where to look |
|------|----------------|
| Install order, FQDN, token steps | [`Makefile`](https://github.com/rh-ai-quickstart/it-self-service-agent/blob/ccc789f9539ea980952c296b91e5744773c8f74b/Makefile) targets **`helm-install-ticketing`**, **`deploy-zammad`**, **`zammad-bootstrap-token`** |
