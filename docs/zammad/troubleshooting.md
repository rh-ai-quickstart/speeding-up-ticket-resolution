...
| Area | Where to look |
|------|----------------|
| Install order, FQDN, token steps | [`Makefile`](https://github.com/rh-ai-quickstart/it-self-service-agent/blob/3ee4fdf294f4c1638f52ba825fd019df6c1f739c/Makefile) targets **`helm-install-ticketing`**, **`deploy-zammad`**, **`zammad-bootstrap-token`** |
