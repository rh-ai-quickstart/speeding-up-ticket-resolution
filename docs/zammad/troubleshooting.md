...
| Area | Where to look |
|------|----------------|
| Install order, FQDN, token steps | [`Makefile`](https://github.com/rh-ai-quickstart/it-self-service-agent/blob/8d7da399430629feecab61326eb8b4445cf22a0a/Makefile) targets **`helm-install-ticketing`**, **`deploy-zammad`**, **`zammad-bootstrap-token`** |
