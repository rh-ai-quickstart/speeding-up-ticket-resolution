...
| Area | Where to look |
|------|----------------|
| Install order, FQDN, token steps | [`Makefile`](https://github.com/rh-ai-quickstart/it-self-service-agent/blob/c50eb25bbd53e62c7d9418ed2c80cdf93a7dd9af/Makefile) targets **`helm-install-ticketing`**, **`deploy-zammad`**, **`zammad-bootstrap-token`** |
